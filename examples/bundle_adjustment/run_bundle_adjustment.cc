...
#include <sym/opt/assert.h>
#include <sym/opt/factor.h>
#include <sym/opt/optimizer.h>

#include "../example_utils/bundle_adjustment_util.h"
...
using namespace bundle_adjustment;
